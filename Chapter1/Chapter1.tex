...
In 2018 the ultra-diffuse galaxy NGC1052-DF2 was observed to have $M_{\mathrm{halo}} / M_{\mathrm{stars}} \sim 1$, a factor of $\sim 400$
...
as how it might form (\citeref{Abraham2018, Ogiya2018}).  Ultimately additional measurements are needed to better quantify NGC1052-DF2,
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{AxionLimits}
\label{fig:axions}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{ColliderIndirectDirectDiagramMaybeFig5Cushman2013}
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{ColliderDiagram}
\label{fig:collider}
\end{figure}
...
\begin{figure}
 ...
 \citeref{SIMPLE2014}), PandaX-II (cyan, \citeref{PandaXII2016}), IceCube (dashed and dotted pink, \citeref{IceCube2017}), and SuperK (dashed and
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{SpinIndependentLimits}
\label{fig:si_limits}
\end{figure}
