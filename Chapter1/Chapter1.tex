...
on Earth (\secref{subsec:indirect}).  The third method is by direct detection in which DM would scatter off SM matter and produce
...
\begin{figure}
 ...
 \caption{Spin-dependent WIMP-proton cross-section 90\% C.L. limits for PICO-60 C$_{3}$F${_8}$ (thick blue, \citeref{PICO2017}), PICO-60
 CF$_{3}$I (thick red,
...
an upgrade reduced their background they were ruled out \citeref{CRESST2015}.
 ...
 %========
\subsection{Noble Gas Detectors} \label{subsec:noble_gas}
Noble gas detectors have led the field for spin-independent WIMPs at masses ${\gtrsim}\, 20\ \mathrm{GeV/c^2}$, as seen in
\figref{fig:si_limits}.  Commissioned detectors have used either liquid argon (LAr) or liquid xenon (LXe) and the
...
Noble gas experiments include the Argon Dark Matter (ArDM) experiment (\citeref{ArDM2013}, DarkSide
(\citeref{DarkSide2018a, DarkSide2018b, DarkSide2018c}), LUX (\citeref{LUX2017a}),
PandaX-II (\citeref{PandaXII2017}), XMASS (\citeref{XMASS2018}), and XENON1T (\citeref{Aprile2018b}).  \figref{fig:si_limits} shows the
