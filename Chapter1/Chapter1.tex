...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{dama_libra_phase2}
...
findings.  Image credit: \citeref{Bernabei2018}.}
\label{fig:dama}
\end{figure}

The DAMA/NaI and its successors DAMA/LIBRA-phase1 and DAMA/LIBRA-phase2 experiments are located underground at the Laboratori Nazionali del
...
\citeref{DAMALIBRA2008}.  For 20 annual cycles they have observed an annual modulation in the
2-6 \kevee (\secref{subsubsec:tpcs_signals_energy})
range with 12.9$\sigma$ \citeref{Bernabei2018}.  This corresponds to WIMP masses of $10 \mdash 15\ \mathrm{GeV/c^2}$ for sodium-scatters
