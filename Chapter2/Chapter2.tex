...
\tabref{tab:xe_isotopes}.  \ce{^{136}Xe}, with a fractional percentage of 8.8573\%,
has been measured to undergo double beta decay with a half-life of $> 2.4 \times 10^{21}\ \mathrm{y}$ via
...
\begin{tabular}{ccccc}
\hline
Isotope & Spin & Half-life & Decay mode \\
\hline
$^{122}$Xe & 0 & 20.1 h & EC to \ce{^{122}I} \\
$^{123}$Xe & 1/2 & 2.08 h & EC to \ce{^{123}I} \\
\ce{^{125}Xe} & 1/2 & 17.1 h & EC to \ce{^{125}I} \\
\ce{^{127}Xe} & 1/2 & 36.4 d & EC to \ce{^{127}I} \\
$\mathrm{^{129m}Xe}$ & 11/2 & 8.88 d & $39.6 + 196.6\ \mathrm{keV}\ \gamma$ to GS \\
$\mathrm{^{131m}Xe}$ & 11/2 & 11.93 d & $163.9\ \mathrm{keV}\ \gamma$ to GS \\
\ce{^{133}Xe} & 3/2 & 5.24 d & $\beta^-$ to \ce{^{133}Cs} \\
$\mathrm{^{133m}Xe}$ & 11/2 & 2.19 d & $233.2\ \mathrm{keV}\ \gamma$ to GS \\
\ce{^{135}Xe} & 3/2 & 9.14 h & $\beta^-$ to \ce{^{135}Cs} \\
\hline
\end{tabular}
\caption{Unstable isotopes of xenon with half-lifes of $> 1\ \mathrm{hr}$.}
