...
Photons can interact with atoms via Compton scattering pair production, or photoelectric absorption.  In Compton scattering the photon
recoils off of an \electron, transfer a portion of its energy.  If the angle of the scatter is known the change in energy can be
determined.
