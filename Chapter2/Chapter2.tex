...
\begin{table}
 ...
 $^{126}$Xe & 0.089 & 0 & $> 4.7 \mdash 12 \times 10^{25}\ \mathrm{yrs}$ & $2\nu \beta^{-} \beta^{-}$ \\
 $^{128}$Xe & 1.910 & 0 & stable & - \\
 $^{129}$Xe & 26.401 & 1/2 & stable & - \\
 $^{130}$Xe & 4.071 & 0 & stable & - \\
 $^{131}$Xe & 21.23 & 3/2 & stable & - \\
 $^{132}$Xe & 26.909 & 0 & stable & - \\
 $^{134}$Xe & 10.436 & 0 &  $> 5.8 \times 10^{22}\ \mathrm{yrs}$ & $2\nu \beta^{-} \beta^{-}$ \\
 $^{136}$Xe & 8.857 & 0 &  $> 2.4 \times 10^{21}\ \mathrm{yrs}$ & $2\nu \beta^{-} \beta^{-}$ \\
 \hline
 \end{tabular}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{XENON1TTPC}
