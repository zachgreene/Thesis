...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{Fig. 1 from SeeFig15.pdf}
\end{figure}
...
Law (\citeref{Birks1964}) derivation for liquid noble gases yields
...
The energy density affects recombination between \electron and ions and is discussed in \secref{recombination}.  Xenon
...
power of $\sim 600-2000\ \mathrm{keV\ \mu m^{-1}}$.  We see that particle tracks are on the order of $10\ \mathrm{\mu m}$, so particles
...
\ce{^{222}Rn} presents a similar problem.  As a daughter of the \uranium decay chain it emanates from the detector materials and distributes
...
is lost to atomic motion the number of quanta produced is $N_{q} = E_{\mathrm{ER}} / W$ where \energyer is the electronic recoil energy
