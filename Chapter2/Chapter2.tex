...
distribution as the light has more area to separate, as well as reflect off the walls.  The light distribution in the top PMT panel
can be used to reconstruct the x-y position of the interaction.
...
\begin{equation}
\Big( \frac{S2}{S1} \Big)_{\mathrm{ER}} > \Big( \frac{S2}{S1} \Big)_{\mathrm{NR}}
\end{equation}
