...
avoid interactions in a higher and nonuniform electric field.

Using a $1.30 \pm 0.01$ t fiducial mass we have
$278.8\ \mathrm{d} \times 1.30\ \mathrm{t} = 1\ \mathrm{t\ yr}$ exposure.
...
The correlation in the ($r_{\mathrm{rec}}^2$, cS2$_{\mathrm{b}}$) panel of \figref{fig:dark_matter_results_bands} shows the additional
discrimination the wall model prediction provides.
