...
intrinsic fluctuation $\Delta r$ that cannot be ignored (\citeref{LUX2016, Aprile2018}).  We assume a truncated Gaussian
...
(\citeref{Aprile2018}).  Red triangles and orange squares represent
...
WIMP spectrum.  While we use the same 1 t volume from First Results and the band fitting rather than the 1.3 t run combined
