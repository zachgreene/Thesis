...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth]{energy_spectrum_rate_kev_kg_day_logscale_pax_v680_hax_v190}
\caption{Combined energy spectrum for XENON1T.  Regions between $55 < E < 140$ and $2350 < E < 2550\ \mathrm{keV}$ are blinded for
\ce{^{element}Xe} double-electron capture and they theorized \ce{^{element}Xe} neutrinoless double $\beta$-decay.}
