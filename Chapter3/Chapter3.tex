...
$g(z^{-1}) = z g(z)$ keeps \eqnref{eq:er_nr_calibrations_parameter_determ_mcmc_walker_update} symmetric - that is, invariant under
...
The likelihood dependence in \eqnref{eq:er_nr_calibrations_parameter_determ_mcmc_prob} can be rewritten as
