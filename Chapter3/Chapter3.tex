...
\caption{Background events in SR1.}
...
where the \ce{^{3}He} and n are expelled at 0.82 and 2.45 MeV, respectively.  It can operate at rates as low as $10\ \mathrm{n\ s^{-1}}$
and as high as $10^7\ \mathrm{n\ s^{-1}}$, which allows gives our objectives more flexibility.

  The NG (NSD Gradel Fusion NSD-35-DD-C-W-S) emits neutrons at ${\sim} 2.2,\ 2.7\ \mathrm{MeV}$ in
