...
\caption{\ce{^{222}Rn} (red), {^{218}Po} (blue), and \ce{^{214}BiPo} (green) event rate concentrations before and after radon
...
Returning to \eqnref{eq:calibrations_s1_s2} we see after solving for $g_1/\eta/g_{2 \mathrm{b}}$ we can reconstruct $E$ for any ER
event.  The (ER)
...
as $\sigma / E = (27.30 \pm 0.37) / \sqrt{E} + (0.65 \pm 0.03)$ including high energy $(> 1.5\ \mathrm{MeV})$ lines and
