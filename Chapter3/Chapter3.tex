...
\hline
$\eta_{EE}$ & $0.933$ & Fixed & $-$ & extraction efficiency \\
...
$f_{\mathrm{NG, ss}} = $ ($f_{\mathrm{NG, ms}} = $).  It is a bit surprising that despite the single scatter cut roughly one third of
events scatter more than once.  However, looking at the energy spectra in
