...
pneumatic and can
be operated remotely with the slow control system (\seccref{subsec:xenon1t_detector_slow_control}).  The remainder are manual valves
...
\figref{fig:attachment_rate} gives a good approximation.  Removing such impurities will be discussed in detail in
