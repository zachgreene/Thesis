...
that govern its recombination and recombination fluctuations.
...
$W$ & $\mu = 0.0137,\ \sigma = 0.0002\ \mathrm{kev}$ & norm &  & \\
$n_{\mathrm{ex}} / n_{\mathrm{ion}}$ & $[0.06,0.2]$ & uniform &  & \\
...
S1 Bias & $[0, 1]$ & uniform &  &  & \\
$\sigma_{b}^{\mathrm{S1}}$ & $[0, 1]$ & uniform &  & \\
$\mu_{b}^{\mathrm{S2}}$ & $[0, 1]$ & uniform &  & \\
$\sigma_{b}^{\mathrm{S2}}$ & $[0, 1]$ & uniform &  &  \\
