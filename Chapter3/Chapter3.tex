...
charge yields for this result along with values from previous experiments.  It should be noted that unlike the other
values displayed in \figref{fig:er_nr_calibrations_results_ly_qy_er} this analysis was not a dedicated $L_y$ or $Q_y$ measurement.  We
...
(\citeref{Aprile2017e}).  Red triangles and orange squares represent
LUX \ce{^{127}Xe} (\citeref{LUX2017}) and tritium (\citeref{LUX2016}), respectively.  Grey triangles represent PIXeY \ce{^{37}Ar}
...
our results(e.g. summing S1s from multiple scatter events that pass our cut or a non-homogeneous energy distribution across the TPC).  We
...
\caption{Photon and charge yields for nuclear recoils.  The dashed blue line indicates
the 10\% acceptance mark for this result, with greater acceptances at higher
energies (\secref{subsec:dark_matter_results_selection}).  This result has $> 10\%$ acceptance for events with energies higher than
indicated by the dashed blue line (\secref{subsec:dark_matter_results_selection}).}
...
yielded 32.1 (SR0) and 246.7 (SR1) for a total of 278.8 days of dark matter data.  Using a $1.30 \pm 0.01$ t FV we have
$278.8\ \mathrm{d} \times 1.30\ \mathrm{t} = 1\ \mathrm{t\ yr}$ exposure.  \figref{fig:dark_matter_results_exposure} shows the
