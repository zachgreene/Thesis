...
maximize resolution of $r$ position reconstruction (\secref{subsec:calibrations_position_reconstruction}).  The 121 in the bottom array
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{Fig6AprileMCPaper}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{MuonFluxWithDepth}
...
been done with \ce{^{83m}Kr}, \ce{^{222}Rn}, \ce{^{137}Cs}, \ce{^{228}Th}, Americium beryllium, a neutron generator, and LEDs.
...
\subsection{\ce{^{83m}Kr}}
\label{subsec:calibrations_kr}
The most common calibration source is \ce{^{83m}Kr}.  Being a noble gas it can be injected directly into the xenon so to be used as an
...
with a 74.8\% branching ratio to the metastable state \ce{^{83m}Kr}.  \ce{^{83m}Kr} then de-excites in two steps: emission of a 32.1 keV
...
\ce{^{83m}Kr} 32.1 keV conversion electron.  The left panel in \figref{fig:calibrations_lce_lce} shows fits to S1s measured below the gate
...
this we use the 41.5 keV peak of \ce{^{83m}Kr} (the 154 ns half-life of the 9.4 keV decay makes it difficult to separate the two
...
and optimized with \ce{^{83m}Kr} data, and achieved a position resolution of $\lesssim 2\ \mathrm{cm}$.  For SR1 the NN was ultimately
chosen, as the TPF algorithm was more sensitive to dead PMTs and showed some artificial discontinuity in the radial
direction.  \figref{fig:calibrations_position_reconstruction} shows the position distribution of events in SR1.

\begin{figure}
    \centering
    \begin{subfigure}[t]{0.45\textwidth}
        \centering
        \includegraphics[height=4.5cm]{S2XY}
    \end{subfigure}%
    \begin{subfigure}[t]{0.45\textwidth}
        \centering
        \includegraphics[height=4.5cm]{S2RZ}
    \end{subfigure}
    \caption{}
...
The 41.5 keV \ce{^{83m}Kr} de-excitation offers a relatively low-energy electronic recoil to measure $\tau_e$.  The number of events
from a typical calibration of 2-3 days is in the millions and any background is negligible.  The left panel of
\figref{fig:calibrations_elifetime_kr} shows a standard electron lifetime calculated using \ce{^{83m}Kr}.
...
\begin{figure}
    ...
    \begin{subfigure}[t]{0.45\textwidth}
        \centering
        \includegraphics[height=4.5cm]{KrElectronLifetime}
    \end{subfigure}%
    \begin{subfigure}[t]{0.45\textwidth}
        \centering
        \includegraphics[height=4.5cm]{Bi212ElectronLifetime}
    \end{subfigure}
    \caption{}
...
decay chain daughter \ce{^{212}Pb}, a number of elements along the chain undergo $\alpha$-decays that can be
...
the 163.9 and 236.1 keV de-excitations of \ce{^{131m}Xe} and \ce{^{129m}Xe}, respectively, following a nuclear recoil calibration are
usable initially but longer time windows are required as they de-excite, and they do not offer the large statistics of \ce{^{83m}Kr} or
\ce{^{220}Rn}.
...
anode changes $E_g$ slightly along $r$ as mentioned in \secref{subsec:calibrations_s2_position_correction} and shown in
...
\label{subsec:calibrations_photon_charge_efficiencies}
The processes for light and charge production were described in \secref{sec:scintillation}.  For electronic recoils atomic motion is
...
\begin{equation}
\frac{E_{er}}{W} = \frac{\mathrm{S1}}{g1} + \frac{\mathrm{S2}}{\eta G_e}
\label{eq:calibrations_s1_s2}
\end{equation}

\noindent where $n_{\gamma} = \mathrm{S1} / g1$ and $n_e = \mathrm{S2} / \eta G_e$ where $g1$ is the average light collection efficiency and $\eta$
...
(\secref{subsec:calibrations_single_electron_gain}) there energy of an event is known \eqref{eq:calibrations_s1_s2} has two unknowns:
$g1$ and $\eta$ (or $g2$).  Rearranging gives

\begin{equation}
\frac{\mathrm{S2}}{E_{er}} = \frac{\eta G_e}{g1} \frac{\mathrm{S1}}{E_{er}} - \frac{\eta G_e}{W}
\end{equation}
...
($g2 = 11.55 \pm 0.01_{\mathrm{stat}} \pm 0.24_{\mathrm{sys}} PE/e^-$).  If we account for the emission of two photoelectrons by a single
photon (\citeref{Faham2015}) the
...
\begin{figure}
    ...
    \begin{subfigure}[t]{0.45\textwidth}
        \centering
        \includegraphics[height=4.5cm]{g1g2Anticorrelation}
    \end{subfigure}%
    \begin{subfigure}[t]{0.45\textwidth}
        \centering
        \includegraphics[height=4.5cm]{TimeDependence}
    \end{subfigure}
    \caption{}
...
labeled with their respective energy and responsible isotope.  We can see that during DM data taking some \ce{^{83m}Kr} is present, most
likely from \ce{^{83}Rb} initially absorbed in the getters but some time later decay.  \ce{^{129m}Xe} and \ce{^{131m}Xe} are clearly
...
include \be{^{214}Bi} (609.3, 1764.5, and 2204.1 keV), \ce{^{60}Co} (1173.2 and 1332.5 keV), \ce{^{40}K} (1460.8 keV), and \ce{^{208}Tl}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{EnergyResolution}
\label{fig:calibrations_photon_charge_efficiences_ces_resolution}
\end{figure}



\subsection{Electronic and Nuclear Band Calibrations}
\label{subsec:calibrations_ambe}
Americium beryllium (AmBe) is used for nuclear recoil calibrations.  \ce{^{241}Am} decays to \ce{^{237}Np} through
$\alpha$-emission.  The large \ce{^{9}Be} cross-section to $\alpha$ particles produces a second decay via
