...
and busy information is constantly read by a separate computer to determine the deadtime.
...
\begin{tabular}{cccccc}
\hline
Parameter & Value & Prior Distribution & Posterior & Units & Note \\
\hline
...
$g_1$ & $\mu = 0.1424,\ \sigma = 0.0062$ & Normal &  & PE/ph & \\
$g_{2b}$ & $\mu = 11.44,\ \sigma = 0.2$ & Normal &  & $\mathrm{PE} / e^-$ & \\
Processor Efficiency & $[0, 1]$ & Normal &  &  & \\
S1 Cut Acceptance & $[0, 1]$ & Normal &  &  & \\
S2 Cut Acceptance & $[0, 1]$ & Normal &  &  & \\
Multiscatter Cut & $[0, 1]$ &  &  &  & \\
$p_{\mathrm{dpe}}$ & $[0.18, 0.24]$ & uniform &  &  & \\
S1 Bias & $[0, 1]$ & uniform &  &  & \\
