...
\caption{Fraction of initial intensity with distance for concentrations of water (left) and \ce{O_2} (right).  Image credit:
\citeref{Ozone2005}.}
...
used.  \figref{fig:g1_g2_chisquare_pax_v680_hax_v240_feb17tofeb18_from_christian_other} (left) presents this for several lines in our
...
\begin{figure}
    ...
    \begin{subfigure}[t]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{g1_g2_chisquare_pax_v680_hax_v240_feb17tofeb18_from_christian_other}
    \end{subfigure}%
    \begin{subfigure}[t]{0.45\textwidth}
        \centering
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{exo_energy_resolution_he_pax_v680_hax_v240_feb17tofeb18_log}
...
interaction.  Charge yield is not shown for \ce{^{222}Rn} because it is significantly lower than its
