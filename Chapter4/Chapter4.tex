...
The delayed coincidence of $\mathrm{^{83m}Kr}$ decays makes it easy to select.
...
(\secref{subsec:det_char_photon_charge_efficiencies}), and electron lifetime.  While these evaluations can provide a cross-check of fellow
electronic recoil measurements from \meta{83m}{Kr}, the short $t_{1/2}$ limit these evaluations to the few weeks following an \ambe or NG
calibration due.
...
%        \centering
    ...
    \end{subfigure}
    \caption{}
	\label{fig:electron_lifetimes_measurement_gammas_s1_s2_half_life}
\end{figure}

Selecting \meta{129}{Xe} and \meta{131}{Xe} events is a bit trickier than $\alpha$ or \meta{83}{Kr}.  This is in part because they sit
...
relatively low event rate, and do not have any properties that allow a high-percentage collection
...
The left panel of \figref{fig:electron_lifetimes_measurement_gammas_s1_s2_half_life} shows the S1-\stwob spectrum for the $num$ days
following the SR1 $ambe or ng$ calibration before any quality cuts.
