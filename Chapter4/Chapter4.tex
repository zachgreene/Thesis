...
Biexcitonic quenching and the Penning process - depicted in \figref{fig:interaction_channels} - decrease
...
two excimers interact and result in an excited and ground state \citeref{Mei2008} - ultimately leading to a single excimer.  Both of these
...
\caption[cS1 median and 68\% credible region for SR0 \ce{^{220}Rn} calibration.]{cS1 for SR0 \ce{^{220}Rn} calibration.  The median and 68\%
...
\caption[cS1 median and 68\% credible region for SR1 \ce{^{220}Rn} calibration.]{cS1 for SR1 \ce{^{220}Rn} calibration.  The median and 68\%
...
\caption[\cstwob for SR0 \ce{^{220}Rn} data with median and 68\% credible interval in slices of cS1.]{\cstwob for SR0 \ce{^{220}Rn} data with
...
\caption[\cstwob for SR1 \ce{^{220}Rn} data with median and 68\% credible interval in slices of cS1.]{\cstwob for SR1 \ce{^{220}Rn}
...
\caption[cS1-$\mathrm{log}_{10}(\mathrm{cS2_b / cS1})$ distribution for the SR0 \ce{^{220}Rn} calibration.  Electronic
...
\ce{^{220}Rn} calibration.  Electronic (red)
...
\caption[cS1-$\mathrm{log}_{10}(\mathrm{cS2_b / cS1})$ distribution for the SR1 \ce{^{220}Rn} calibration.  Electronic
and nuclear recoil medians and $\pm 2\sigma$ are marked in solid and dashed
lines.  Accidental coincidence is shown in the bottom panel.]{cS1-$\mathrm{log}_{10}(\mathrm{cS2_b / cS1})$ distribution for the SR1
\ce{^{220}Rn} calibration.  Electronic recoil
...
\caption[\cstwob in slices of cS1 for SR0 \ambe data.]{\cstwob in slices of cS1 for SR0 \ambe data.  The band fitting results (blue) match
the data nicely. The ratio of multi- (green)
