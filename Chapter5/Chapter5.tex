...
$c_p$ & 158 & $\mathrm{J\ kg^{-1}}$ & Constant pressure specific heat of GXe, \secref{subsec:electron_lifetime_model_vap_and_cond} \\
$L$ & $9.5587 \times 10^4$ & $\mathrm{J\ kg^{-1}}$ & Latent heat of GXe, \secref{subsec:electron_lifetime_model_vap_and_cond} \\
$Q_0$ & $140$ & W & GXe cooling power when $F_{\mathrm{G}} + F_{\mathrm{L}} = 0$, \secref{subsec:electron_lifetime_model_vap_and_cond} \\
\hline
\hline
\end{tabular}
}
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{electron_lifetime_evolution_model}
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{electron_lifetime_kr_correction}
