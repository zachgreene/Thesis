...
\caption{Electron lifetime measurements from S2/S1 (blue circles), combined \ce{^{222}Rn}-\ce{^{218}Po} (green triangles), \ce{^{222}Rn}
...
\ce{^{222}Rn}-\ce{^{218}Po} combined (green), \ce{^{222}Rn},
...
\figref{fig:electron_lifetime_model_detector_effects_getter_getter_defficiencies}.
...
Getter defficiencies model periods when the electron lifetime begins to decrease without an explanation.  There are three that are modeled
...
\caption{Getter defficiencies medians and 68\% credible intervals.  The first getter defficiency is not understood, but the latter two are
...
\label{tab:elifetime_fit_results_posteriors_getter_defficiencies}
\end{table}
\egroup
...
\caption{Electron lifetime model and data over the lifetime of XENON1T.  Electron lifetimes calculated via the S2/S1 method (blue circle),
\ce{^{222}Rn}-\ce{^{218}Po} (green triangle), \ce{^{212}Bi} (red triangle), \ce{^{218}Po} (turquoise triangle), \ce{^{222}Rn} (yellow
triangle), and \metakr (black circle) are shown.  The best-fit trend (red line) and 68\% credible region (shaded blue) are overlaid for
comparison.  Dashed lines correspond to events that affected the evolution of the electron lifetime.}
