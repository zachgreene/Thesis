...
\newcommand{\jpcss}{Journal of Physics C}
...
%  backend=bibtex
%]{biblatex}
\usepackage[backend=bibtex,bibstyle=ieee,sorting=none,style=numeric-comp]{biblatex}
\renewbibmacro{in:}{}
...
\copypagestyle{cu}{ruled}
	\makeevenhead{cu}{}{\leftmark}{}
	\makeoddhead{cu}{}{\rightmark}{}
...
\frontmatter
\begin{KeepFromToc}
        \pagestyle{plain}\tableofcontents{\protect\thispagestyle{plain}} % You need to put your ToC after frontmatter so that it will get lowercase Roman numerals.
\end{KeepFromToc}
%\clearpage
...
\pagestyle{plain}\listoffigures{\protect\thispagestyle{plain}}
%\listoffigures

% Acknowledgements
\pagestyle{plain}\include{./FrontMatter/Acknowledgments}
